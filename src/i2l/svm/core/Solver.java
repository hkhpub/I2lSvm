...
import i2l.svm.core.kernel.QMatrix;
import i2l.svm.utils.Utils;

/**
 * 
 * @author hkh (Libsvm) 
 * 	An SMO algorithm in Fan et al., JMLR 6(2005), p.
 *         1889--1918 Solves:
 *
 ...
 *         Given:
 *
 *         Q, p, y, Cp, Cn, and an initial feasible point \alpha l is the size
 *         of vectors and matrices eps is the stopping tolerance
 *
...
//		}
	...
	protected void Solve(int l, QMatrix Q, double[] p_, byte[] y_, double[] alpha_,
